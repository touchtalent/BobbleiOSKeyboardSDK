...
#ifndef BOBBLEKEYBOARDSDK_SWIFT_H
#define BOBBLEKEYBOARDSDK_SWIFT_H
...
@protocol WordSuggestionDelegate
- (void)bobbleKeyboard:(BLKeyboardViewController * _Nonnull)bobbleKeyboard nextWordsfor:(NSString * _Nonnull)word previousWord:(NSString * _Nonnull)previousWord pressedCharacter:(NSString * _Nonnull)pressedCharacter isTextBeforeInput:(BOOL)isTextBeforeInput textBeforeInput:(NSString * _Nonnull)textBeforeInput touchPoint:(CGPoint)touchPoint completionHandler:(SWIFT_NOESCAPE void (^ _Nonnull)(WordSuggestion * _Nonnull))completionHandler;
...
- (void)bobbleKeyboard:(BLKeyboardViewController * _Nonnull)bobbleKeyboard keyCharArray:(NSArray<NSString *> * _Nonnull)keyCharArray keyFrameArray:(NSArray<NSValue *> * _Nonnull)keyFrameArray keyboardWidth:(CGFloat)keyboardWidth keyboardheight:(CGFloat)keyboardheight;
@end

typedef SWIFT_ENUM(NSInteger, predictionSource, closed) {
  predictionSourceBackspace = 0,
  predictionSourceSpace = 1,
  predictionSourceDot = 2,
  predictionSourceComma = 3,
  predictionSourceSemicolon = 4,
  predictionSourceSlash = 5,
  predictionSourceQuestionMark = 6,
  predictionSourceExclamationMark = 7,
  predictionSourceSuggestionPressed = 8,
};
